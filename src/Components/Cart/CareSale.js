...
class CareSale extends Component {
    constructor(props){
        super(props);
        items=[]
        this.state = {
    ...
    componentDidMount(){
        that = this;
        var query = firebaseApp.database().ref('PostSale').orderByChild('Care').equalTo(true);
...
export default connect(mapStateToProps)(CareSale);
