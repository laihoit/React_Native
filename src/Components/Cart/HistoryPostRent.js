...
class HistoryPostRent extends Component {
    constructor(props){
        super(props);
        items=[]
        this.state = {
    ...
    componentDidMount(){
        that = this;
        var query = firebaseApp.database().ref('PostRent').orderByChild('User').equalTo(this.props.mystate);
...
export default connect(mapStateToProps)(HistoryPostRent);
