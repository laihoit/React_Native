...
class CurrentRent extends Component {
    constructor(props){
        super(props);
        items=[]
        this.state = {
    ...
    componentDidMount(){
        ...
        var query = firebaseApp.database().ref('PostRent').orderByChild('Date').equalTo(date);
...
export default connect(mapStateToProps)(CurrentRent);
